...
namespace GenericWebshop.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CategoryId,Title")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CategoryId,Title")] Category category)
        {
            if (ModelState.IsValid)
            {
